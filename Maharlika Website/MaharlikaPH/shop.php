...
<html lang="en">
    ...
    <style>
        ...
        *----------------*/
        ...
        main .title::before{
            ...
            width: 60px;
            border-radius: 5px;
            background: linear-gradient(135deg, #9096CA, var(--main-color));
        }
    ...
    <body>
        ...
        <main>
            ...
            <div class="title">Product Control</div>
            <div class="products">
                        ...
                        ?>
                            <tr>
                                <div class="prod">
                                    ...
                                    <td><a href="del.php?pid=<?php echo $productId;?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a> | <a href="update.php?pid=<?php echo $productId;?>">Update</a></th>
                                </div>
                            </tr>
                        <?php } ?>
                        
                    </table>
                        <div class="icons"><a href="UserShop.php"><i class="fa fa-shopping-basket"></i> Add Item</a></div>
